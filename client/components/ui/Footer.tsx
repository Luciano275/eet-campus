  ...
  social: [
    {
      ...
      name: "facebook",
      hoverIcon: <FaFacebookF className="text-blue-600" size={25} />,
    },
    {
      icon: BsInstagram,
      link: "",
      name: "instagram",
      hoverIcon: (
        <Image src="/assets/instagram.png" alt="l" width={25} height={25} />
      ),
    },
  ],
};
  ...
  return (
    <nav className="flex flex-col items-center">
      ...
      <div className="flex gap-4">
        {INFO.social.map(
          ({ icon: Icon, link, name, hoverIcon: hoverIcon }, index) => (
            <a
              href={link}
              key={`${index}:${link}`}
