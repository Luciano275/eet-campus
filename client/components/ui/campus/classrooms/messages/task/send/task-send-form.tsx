...
import { ClassroomMessagesResponse, SendTaskActionResponse } from "@/types";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-4 [&>*]:grow">
        ...
        <button className={`btn btn-md btn-success text-white ${isPending && 'contrast-0'}`} disabled={isPending} aria-disabled={isPending}>
          Enviar tarea
        </button>
      </div>
