...
export default function DeleteAttachment (
  ...
  return (
    <span onClick={() => handleDeleteFile(file)} className="absolute top-0 left-0 w-full h-full bg-red-500/10 backdrop-blur-xs hover:text-blue-500 transition-opacity opacity-0 hover:opacity-100 cursor-pointer flex justify-center items-center">
      <FaTrash size={20} />
    </span>
  )
}