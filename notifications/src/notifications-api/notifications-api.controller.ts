...
export class NotificationsApiController {
  ...
  async getNotifications(
    ...
    try {
      const notifications = await this.notificationsApiService.findNotifications(queryDto);
  ...
  async addNotification(
    ...
    try {
      const notifications = await this.notificationsApiService.createNotification(createNotificationDto, queryDto)
